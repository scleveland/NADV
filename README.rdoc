...
This is a Ruby on Rails Application so to get started I recommend cloning the repository and running bundle install and then rake db:setup and it should be good to go.
